...
export class BookDetailComponent implements OnInit {
  ...
  constructor(private _route: ActivatedRoute,
    private _router: Router, private _dataService: DataService, private _snackBar: MatSnackBar) { }
  ...
  updateBook(book: Ibook): void {
    this._dataService.updateBook(book).subscribe(books => {
